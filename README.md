...
Native macOS terminal, GPU-rendered, written in pure Rust.

This repository hosts the **official releases** of Nova Terminal. It is read-only: no pushes, no pull requests.
